    ...
    <div id="taskModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- REVISI: Tambah Field Penanggung Jawab di Modal -->
                <div class="modal-field">
                    <div class="modal-field-label">Penanggung Jawab</div>
                    <div class="modal-field-value" id="taskPenanggungJawab">-</div>
                </div>
            </div>
...
<script>
    ...
    function populateModalContent(task) {
        ...
        // REVISI: Tambah Tampilan Penanggung Jawab di Modal
        const penanggungJawabEl = document.getElementById('taskPenanggungJawab');
        if (penanggungJawabEl) {
            penanggungJawabEl.textContent = task.penanggung_jawab || 'Belum ditentukan';
            penanggungJawabEl.className = task.penanggung_jawab ? 'modal-field-value' : 'modal-field-value empty';
        }
        ...
        <label class="modal-field-label">Ubah Warna</label>
            ...
            if (ganttBar) {
                ...
                if (taskId !== currentTaskId) {
                    ...
                    if (task) {
                        ...
                        const penanggungJawab = task.penanggung_jawab || 'Belum ditentukan';
                        tooltip.innerHTML = `
                        ...
                        <!-- REVISI: Tambah Penanggung Jawab di Tooltip -->
                        <div class="tooltip-field"><span>Penanggung Jawab:</span> <span class="value">${penanggungJawab}</span></div>`;
                    }
                }
